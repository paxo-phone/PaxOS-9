...
{
    testCommand("info", true, Command::CommandType::info, VERSION_MESSAGE + HARDWARE_MESSAGE + HOSTNAME_MESSAGE + BLUETOOTH_MAC_MESSAGE + WIFI_MAC_MESSAGE);
    ...
    testCommand("info mac", true, Command::CommandType::info, BLUETOOTH_MAC_MESSAGE + WIFI_MAC_MESSAGE);
    ...
    testCommand("info invalid", true, Command::CommandType::info, INFO_COMMAND_NOT_RECOGNIZED("invalid"));
    testCommand("info invalid", false, Command::CommandType::info, NON_SHELL_MODE_ERROR_CODE);
    testCommand("info mac invalid", true, Command::CommandType::info, INFO_COMMAND_NOT_RECOGNIZED_MAC("invalid"));
