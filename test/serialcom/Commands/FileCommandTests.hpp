...
TEST(Commands, FILE_COMMANDS)
{
    ...
    */
    ...
    testCommand("mkdir /FILE_COMMANDS_TEST", true, Command::CommandType::mkdir, DIRECTORY_CREATION_SUCCESS("/FILE_COMMANDS_TEST"));
    testCommand("mkdir /FILE_COMMANDS_TEST_NON_SHELL_MODE", false, Command::CommandType::mkdir, NON_SHELL_MODE_NO_ERROR_CODE);

    

    testCommand("mkdir /FILE_COMMANDS_TEST", true, Command::CommandType::mkdir, DIRECTORY_ALREADY_EXISTS("/FILE_COMMANDS_TEST"));
    ...
    */
    ...
    testCommand("touch /FILE_COMMANDS_TEST/file.txt", true, Command::CommandType::touch, FILE_CREATION_SUCCESS("/FILE_COMMANDS_TEST/file.txt"));
    ...
    testCommand("touch /FILE_COMMANDS_TEST/file.txt", true, Command::CommandType::touch, FILE_ALREADY_EXISTS("/FILE_COMMANDS_TEST/file.txt"));
    ...
    */
    ...
    testCommand("rm /FILE_COMMANDS_TEST/file.txt", true, Command::CommandType::rm, PATH_DOES_NOT_EXIST("/FILE_COMMANDS_TEST/file.txt"));
   ...
   // TODO find a way to test the upload command
    ...
    //testCommand("upload /FILE_COMMANDS_TEST/test.txt 10\0MTIzNDU2Nzg5MA==", true, Command::CommandType::upload, "Uploading file to /FILE_COMMANDS_TEST/test.txt with size 10 bytes\nFile /FILE_COMMANDS_TEST/test.txt with size 10 uploaded successfully.\n");
    //testCommand("upload /FILE_COMMANDS_TEST_NON_SHELL_MODE/test.txt 10\0MTIzNDU2Nzg5MA==", false, Command::CommandType::upload, NON_SHELL_MODE_NO_ERROR_CODE);

    //testCommand("download /FILE_COMMANDS_TEST/test.txt", true, Command::CommandType::download, "File size 10\nMTIzNDU2Nzg5MA==\nNo error.\n");
    //testCommand("download /FILE_COMMANDS_TEST_NON_SHELL_MODE/test.txt", false, Command::CommandType::download, "10\nMTIzNDU2Nzg5MA==");

    testCommand("download /FILE_COMMANDS_TEST", true, Command::CommandType::download, FILE_CANNOT_BE_OPENED("/FILE_COMMANDS_TEST"));
    testCommand("download /FILE_COMMANDS_TEST_NON_SHELL_MODE", false, Command::CommandType::download, NON_SHELL_MODE_ERROR_CODE);
    ...
    testCommand("touch /FILE_COMMANDS_TEST/emptyFile.txt", true, Command::CommandType::touch, FILE_CREATION_SUCCESS("/FILE_COMMANDS_TEST/emptyFile.txt"));
...
// cp and mv tests, read result to make sure it works
    ...
    testCommand("cp /FILE_COMMANDS_TEST/emptyFile.txt /FILE_COMMANDS_TEST/emptyFileCopy.txt", true, Command::CommandType::cp, COPY_SUCCESS("/FILE_COMMANDS_TEST/emptyFile.txt", "/FILE_COMMANDS_TEST/emptyFileCopy.txt"));
    testCommand("cp /FILE_COMMANDS_TEST_NON_SHELL_MODE/emptyFile.txt /FILE_COMMANDS_TEST_NON_SHELL_MODE/emptyFileCopy.txt", false, Command::CommandType::cp, NON_SHELL_MODE_NO_ERROR_CODE);

    //testCommand("cp FILE_COMMANDS_TEST/test.txt FILE_COMMANDS_TEST/testCopy.txt", true, Command::CommandType::cp, "File FILE_COMMANDS_TEST/test.txt copied to FILE_COMMANDS_TEST/testCopy.txt.\n");
    ...
    testCommand("mv /FILE_COMMANDS_TEST/emptyFile.txt /FILE_COMMANDS_TEST/emptyFileMoved.txt", true, Command::CommandType::mv, MOVE_SUCCESS("/FILE_COMMANDS_TEST/emptyFile.txt", "/FILE_COMMANDS_TEST/emptyFileMoved.txt"));
    testCommand("mv /FILE_COMMANDS_TEST_NON_SHELL_MODE/emptyFile.txt /FILE_COMMANDS_TEST_NON_SHELL_MODE/emptyFileMoved.txt", false, Command::CommandType::mv, NON_SHELL_MODE_NO_ERROR_CODE);

    //testCommand("mv FILE_COMMANDS_TEST/test.txt FILE_COMMANDS_TEST/testMoved.txt", true, Command::CommandType::mv, "File FILE_COMMANDS_TEST/test.txt moved to FILE_COMMANDS_TEST/testMoved.txt.\n");
    ...
    testCommand("rm /FILE_COMMANDS_TEST/emptyFileMoved.txt", true, Command::CommandType::rm, PATH_REMOVAL_SUCCESS("/FILE_COMMANDS_TEST/emptyFileMoved.txt"));
    testCommand("rm /FILE_COMMANDS_TEST_NON_SHELL_MODE/emptyFileMoved.txt", false, Command::CommandType::rm, NON_SHELL_MODE_NO_ERROR_CODE);

    //testCommand("rm FILE_COMMANDS_TEST/testMoved.txt", true, Command::CommandType::rm, "File or directory FILE_COMMANDS_TEST/testMoved.txt removed.\n");
    //testCommand("rm FILE_COMMANDS_TEST_NON_SHELL_MODE/testMoved.txt", false, Command::CommandType::rm, NON_SHELL_MODE_NO_ERROR_CODE);

    testCommand("rm /FILE_COMMANDS_TEST", true, Command::CommandType::rm, PATH_REMOVAL_SUCCESS("/FILE_COMMANDS_TEST"));
    testCommand("rm /FILE_COMMANDS_TEST_NON_SHELL_MODE", false, Command::CommandType::rm, NON_SHELL_MODE_NO_ERROR_CODE);

    testCommand("ls /FILE_COMMANDS_TEST", true, Command::CommandType::ls, DIRECTORY_DOES_NOT_EXIST("/FILE_COMMANDS_TEST"));
    testCommand("ls /FILE_COMMANDS_TEST_NON_SHELL_MODE", false, Command::CommandType::ls, NON_SHELL_MODE_ERROR_CODE);
}