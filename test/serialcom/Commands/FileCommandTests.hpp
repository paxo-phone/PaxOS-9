...
TEST(Commands, FILE_COMMANDS)
{
    ...
    */
    ...
    // Command::CommandType::mkdir, "Error creating directory
    // FILE_COMMANDS_TESTç*\"+_=?%:\n\t\r"); testCommand("mkdir
    // FILE_COMMANDS_TEST_NON_SHELL_MODEç*\"+_=?%:\n\t\r", false,
    // Command::CommandType::mkdir, NON_SHELL_MODE_ERROR_CODE);
    ...
    */
    ...
    //         uploadPath.str() + " with size " + command.arguments[1] + "
    //         bytes");

    // executeCommand("rm /FILE_COMMANDS_TEST/test.txt", true);
    // executeCommand("rm /FILE_COMMANDS_TEST_NON_SHELL_MODE/test.txt", true);

    // testCommand("upload /FILE_COMMANDS_TEST/test.txt 10\0MTIzNDU2Nzg5MA==",
    // true, Command::CommandType::upload, "Uploading file to
    // /FILE_COMMANDS_TEST/test.txt with size 10 bytes\nFile
    // /FILE_COMMANDS_TEST/test.txt with size 10 uploaded successfully.\n");
    // testCommand("upload /FILE_COMMANDS_TEST_NON_SHELL_MODE/test.txt
    // 10\0MTIzNDU2Nzg5MA==", false, Command::CommandType::upload,
    // NON_SHELL_MODE_NO_ERROR_CODE);

    // testCommand("download /FILE_COMMANDS_TEST/test.txt", true,
    // Command::CommandType::download, "File size 10\nMTIzNDU2Nzg5MA==\nNo
    // error.\n"); testCommand("download
    // /FILE_COMMANDS_TEST_NON_SHELL_MODE/test.txt", false,
    ...
    // testCommand("download /FILE_COMMANDS_TEST_NON_SHELL_MODE/emptyFile.txt",
    // false, Command::CommandType::download, "0");
    ...
    // testCommand("cp FILE_COMMANDS_TEST/test.txt
    // FILE_COMMANDS_TEST/testCopy.txt", true, Command::CommandType::cp, "File
    // FILE_COMMANDS_TEST/test.txt copied to
    // FILE_COMMANDS_TEST/testCopy.txt.\n"); testCommand("cp
    // FILE_COMMANDS_TEST_NON_SHELL_MODE/test.txt
    // FILE_COMMANDS_TEST_NON_SHELL_MODE/testCopy.txt", false,
    // Command::CommandType::cp, NON_SHELL_MODE_NO_ERROR_CODE);
    ...
    testCommand(
        ...
        false,
        Command::CommandType::ls,
        "{\"directories\":[],\"files\":[\"emptyFile.txt\",\"emptyFileCopy."
        "txt\"]}"
    );
    ...
    // testCommand("mv FILE_COMMANDS_TEST/test.txt
    // FILE_COMMANDS_TEST/testMoved.txt", true, Command::CommandType::mv, "File
    // FILE_COMMANDS_TEST/test.txt moved to
    // FILE_COMMANDS_TEST/testMoved.txt.\n"); testCommand("mv
    // FILE_COMMANDS_TEST_NON_SHELL_MODE/test.txt
    // FILE_COMMANDS_TEST_NON_SHELL_MODE/testMoved.txt", false,
    // Command::CommandType::mv, NON_SHELL_MODE_NO_ERROR_CODE);
    ...
    testCommand(
        ...
        false,
        Command::CommandType::ls,
        "{\"directories\":[],\"files\":[\"emptyFileCopy.txt\",\"emptyFileMoved."
        "txt\"]}"
    );
    ...
    // Command::CommandType::download, "File size 0\nNothing in the file");
    // testCommand("download
    // /FILE_COMMANDS_TEST_NON_SHELL_MODE/emptyFileCopy.txt", false,
    // Command::CommandType::download, "0");

    // testCommand("download FILE_COMMANDS_TEST/testCopy.txt", true,
    // Command::CommandType::download, "File size 10\nMTIzNDU2Nzg5MA==\nNo
    // error.\n"); testCommand("download
    // FILE_COMMANDS_TEST_NON_SHELL_MODE/testCopy.txt", false,
    // Command::CommandType::download, "10\nMTIzNDU2Nzg5MA==");
    ...
    // testCommand("rm FILE_COMMANDS_TEST/testMoved.txt", true,
    // Command::CommandType::rm, "File or directory
    // FILE_COMMANDS_TEST/testMoved.txt removed.\n"); testCommand("rm
    // FILE_COMMANDS_TEST_NON_SHELL_MODE/testMoved.txt", false,
    // Command::CommandType::rm, NON_SHELL_MODE_NO_ERROR_CODE);
