...
/**
 * @brief It is a simple virtual screen where you can draw pixels or shapes as you want. Useful for
 *games or custom widgets
 **/
class Canvas final : public ElementBase {
  public:
    ...
    void drawRoundRect(int16_t x, int16_t y, uint16_t w, uint16_t h, uint16_t radius,
                       color_t color);
    void fillRoundRect(int16_t x, int16_t y, uint16_t w, uint16_t h, uint16_t radius,
                       color_t color);
    ...
    void drawTextCentered(int16_t x, int16_t y, std::string& text, color_t color,
                          bool horizontallyCentered = true, bool verticallyCentered = true,
                          float fontSize = 16);
    void drawTextCenteredInRect(int16_t x, int16_t y, uint16_t w, uint16_t h, std::string& text,
                                color_t color, bool horizontallyCentered = true,
                                bool verticallyCentered = true, float fontSize = 16);
};
} // namespace gui::elements
