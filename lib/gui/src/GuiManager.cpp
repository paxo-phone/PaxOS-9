...
int GuiManager::showMessage(WINDOW_TYPE type, const std::string& msg)
{
    ...
    auto msgWindow = std::make_shared<gui::elements::Canvas>(20, 120, 280, 200);
    ...
    auto title = std::make_shared<gui::elements::Label>(20, 7, 80, 20);
    title->setText(strTitle);
    title->setTextColor(color_text);
    msgWindow->addChild(title);

    auto txt = std::make_shared<gui::elements::Label>(20, 60, 240, 80);
    txt->setText(msg);
    ...
    auto btnOK = std::make_shared<gui::elements::Button>(100, 150, 100, 30);
    btnOK->setText("OK");
