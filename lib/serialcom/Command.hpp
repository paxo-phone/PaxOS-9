...
constexpr size_t INPUT_MAX_SIZE =
    COMMAND_HEADER_SIZE + COMMAND_ID_SIZE + MAX_COMMMAND_TYPE_SIZE +
...
struct Command {
    ...
    static std::unordered_map<CommandType, std::string>
        command_types_raw_strings;
